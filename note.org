...
& is lvalue reference
&& is rlvalue reference.

* continuous integration

automatically test after building your project to github

this need 10 dollar per month...
...
it is an extension of visual-studio.
...
before C++ 17, it is undefined.

* TODO Move Semantics

allow us to move class around.
...
move semantics is change the deep copy to shallow copy.


* TODO std::move and the move assignment operator
...
move value from one variable to another variable. 
